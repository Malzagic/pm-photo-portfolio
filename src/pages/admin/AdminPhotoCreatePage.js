...
export function AdminPhotoCreatePage() {
    ...
    return (<div className="admin-create-page">
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 400 }}>
        ...
        {/* PHOTO TITLE */}
        <input type="text" placeholder="Photo Title" value={title} onChange={e => setTitle(e.target.value)} disabled={loading} style={{
            padding: "10px",
            borderRadius: 4,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <select value={category} onChange={e => setCategory(e.target.value)} disabled={loading} style={{
            padding: "10px",
            borderRadius: 4,
            border: "1px solid rgba(255,255,255,0.1)",
            background: "#111",
        ...
        <div style={{ display: "flex", gap: 20 }}>
          ...
          <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
            <input type="checkbox" checked={featured} onChange={e => setFeatured(e.target.checked)} disabled={loading}/>
            Featured
          </label>
        </div>
